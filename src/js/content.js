const allData = [
  ...
  [`Files`, `文件`],
  [`Wiki`, `维基`],
  ['Top repositories`, `最近的仓库`],
  [`Dashboard`, `仪表盘`],
  // Copilot 相关
  [`Open issues in`, `打开问题在`],
  [`Ask Copilot`, `询问 Copilot`],
  ['Extend GitHub Copilot with ready-to-use extensions or build your own using our developer platform with APIs, documentation, and guides.', '使用即用型扩展来扩展 GitHub Copilot，或者使用我们的开发者平台（包含 API、文档和指南）构建您自己的扩展。'],
  ['Extensions are here!', '扩展已推出！'],
  ['Editing', '编辑'],
  ['Filter', '筛选'],
  ['What can I do here?', '我能做什么？'],
  [`Python Panda data analysis`, `Python Panda 数据分析`],
  ['Generate an HTML/JS calculator','生成 HTML/JS 计算器']
  ...
  [`关于`, `关于`],
  [`置顶`, `置顶`],
  [`置顶this repository to your profile`, `置顶这个项目到你的个人信息`],
  [`新建repository`, `新建仓库`],
